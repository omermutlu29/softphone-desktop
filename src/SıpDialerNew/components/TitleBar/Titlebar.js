    ...
    <div className='Titlebar'>
      <div className={isActive ? 'Title-Bar' : 'Title-Bar-inactive'}>
        ...
        <div className='Title-Bar__section-icon'  >
          <span style={{marginLeft:5}}>Jettel - Softphone</span>
        </div>
        ...
        <div className='Title-Bar__section-windows-control'>
          <div
            ...
            <svg xmlns='http://www.w3.org/2000/svg' width='14' height='14' viewBox='0 0 24 24' strokeLinejoin='round'>
              <circle onClick={minimizeHandler} className={isActive ? 'minimize-active_logo' : 'minimize-inactive_logo'}
          ...
          <div
            className='section-windows-control_box'>
            <svg xmlns='http://www.w3.org/2000/svg' width='14' height='14' viewBox='0 0 24 24' strokeLinejoin='round'>
              <circle onClick={closeHandler} className={isActive ? 'close-active_logo' : 'close-inactive_logo'}
                      cx='11.6' cy='11.6' r='11.4' />
            </svg>
          </div>
        </div>
